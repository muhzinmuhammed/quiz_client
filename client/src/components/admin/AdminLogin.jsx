...
import { useAdminLoginMutation } from '../../features/api/userAuth/userAuth'; // Import the useAdminLoginMutation hook
...
const userLogin = () => {
  ...
  const [login, { isLoading }] = useAdminLoginMutation(); // Destructure the mutation
  // eslint-disable-next-line react-hooks/rules-of-hooks
